...
public class AcessoController {
    ...
    @PostMapping("/login")
    @Operation(summary = "Fazer login", description = "Valida as credenciais do usuário")
    @ApiResponses(value = {
    ...
    public ResponseEntity<AcessoResponse> login(@Valid @RequestBody AcessoRequest request) {
        AcessoResponse response = acessoService.login(request.getUsuario(), request.getSenha());
