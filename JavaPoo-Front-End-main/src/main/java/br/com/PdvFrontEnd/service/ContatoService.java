...
public class ContatoService {
    ...
    public void addContato(Contato contato) {
        try {
            ...
            HttpClient.post("/contatos", request, ContatoResponse.class);
    ...
    public List<Contato> getAllContatos() {
        try {
            ContatoResponse[] responses = HttpClient.getArray("/contatos", ContatoResponse[].class);
    ...
    public void updateContato(Long id, Contato contato) {
        try {
            ...
            HttpClient.put("/contatos/" + id, request, ContatoResponse.class);
            JOptionPane.showMessageDialog(null,
